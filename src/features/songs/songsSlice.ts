...
export const { clearTopSongs } = songsSlice.actions
export default songsSlice.reducer

export const selectTopSongs = (state: RootState) => state.songs.data
export const selectTopSongsStatus = (state: RootState) => state.songs.status
export const selectTopSongsError = (state: RootState) => state.songs.error